...
struct UserProfile: Codable {
    ...
    static func fromSupabase(data: [String: Any]) -> UserProfile? {
        ...
        let profileImageDataString = data["profile_image_data"] as? String
        let profileImageData = profileImageDataString != nil ? Data(base64Encoded: profileImageDataString!) : nil
